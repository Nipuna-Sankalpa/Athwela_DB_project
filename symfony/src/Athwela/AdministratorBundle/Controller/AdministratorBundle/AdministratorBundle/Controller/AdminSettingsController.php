...
class AdminSettingsController extends Controller {
    ...
    public function indexAction() {
        ...
        $mobiNo = Read::getInstance()->readSpecific('mobile_number','admin_mobile','admin_ID',$id);
    ...
    public function updatesAction() {
        ...
        if (array_key_exists('fName', $data)) {
            ...
            Update::getInstance()->updateSpecific('admin_mobile', 'admin_ID', $id, 'mobile_number', $data['mobi']);
        }   
